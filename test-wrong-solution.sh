...
echo ""
echo "=========================================="
echo "Expected: Some test cases should FAIL"
echo "Bug: Uses min heap instead of max heap"
echo "=========================================="
